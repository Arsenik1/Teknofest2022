...
vy=0
vz=0
redAreaCenter = LocationGlobalRelative(40.2314190,28.8730291,HOVERING_ALTITUDE)
rectflag = False
redAreaTime= False
...
if __name__ == "__main__":
    ...
    waterPool = LocationGlobalRelative(40.2314454,28.8727749,2.7)
    waterPoolHigh = LocationGlobalRelative(40.2314454,28.8727749,7)
    cmds = drone.commands
    cmds.clear() 
    addWaypoint(cmds,40.2314714,28.8729776,HOVERING_ALTITUDE)#duz git #dummy
    addWaypoint(cmds,40.2314714,28.8729776,HOVERING_ALTITUDE)#duz git
    addWaypoint(cmds,40.2314307,28.8728820,HOVERING_ALTITUDE)#sari çizgi
    #red area is in 3 and 4th waypoints
    addWaypoint(cmds,40.2314282,28.8730777,HOVERING_ALTITUDE)#kirmizi sonu
    addWaypoint(cmds,40.2314556,28.8731225,HOVERING_ALTITUDE)#direge capraz
    addWaypoint(cmds,40.2314793,28.8730653,HOVERING_ALTITUDE)#asagi capraz
    addWaypoint(cmds,40.2314897,28.8729110,HOVERING_ALTITUDE)#cizgiyi gec
    addWaypoint(cmds,40.2314897,28.8729110,HOVERING_ALTITUDE) #dummy
    ...
    processflag=False
    addWaypoint(cmds,40.2314897,28.8729110,HOVERING_ALTITUDE)#cizgiyi gec 
    addWaypoint(cmds,40.2314851,28.8728454,HOVERING_ALTITUDE)
    ...
    while True:
        take_water(0,0,0.2)
        print(drone.location.global_relative_frame.alt)
        if drone.location.global_relative_frame.alt <= 2.00:
            break
    take_water(0,0,0)
    time.sleep(1)
    """
    ...
    cmds.clear() 
    processflag=False
    addWaypoint(cmds,40.2314282,28.8730777,HOVERING_ALTITUDE)#kirmizi sonu #dummy
    addWaypoint(cmds,40.2314282,28.8730777,HOVERING_ALTITUDE)#kirmizi sonu
    addWaypoint(cmds,40.2314556,28.8731225,HOVERING_ALTITUDE)#direge capraz
    addWaypoint(cmds,40.2314793,28.8730653,HOVERING_ALTITUDE)#asagi capraz
    addWaypoint(cmds,40.2314897,28.8729110,HOVERING_ALTITUDE)#cizgiyi gec
