...
if __name__ == "__main__":
    ...
    waterPool = LocationGlobalRelative(40.8118465,29.3603445,6)
    cmds = drone.commands
    cmds.clear()
    #Cleared all commands.
    #Commands will come from mission planner.
    addWaypoint(cmds,40.812002,29.3602967,HOVERING_ALTITUDE)#duz git #dummy
    addWaypoint(cmds,40.812002,29.3602967,HOVERING_ALTITUDE)#duz git
    addWaypoint(cmds,40.8119096,29.3602619,HOVERING_ALTITUDE)#sari çizgi
    #red area is in 3 and 4th waypoints
    addWaypoint(cmds,40.8118478,29.3603441,HOVERING_ALTITUDE)#kirmizi sonu
    addWaypoint(cmds,40.8118731,29.3605569,HOVERING_ALTITUDE)#direge capraz
    addWaypoint(cmds,40.8120665,29.3605703,HOVERING_ALTITUDE)#asagi capraz
    addWaypoint(cmds,40.812068,29.360406,HOVERING_ALTITUDE)#cizgiyi gec
    addWaypoint(cmds,40.812002,29.3602967,HOVERING_ALTITUDE) #last waypoint
    addWaypoint(cmds,40.812002,29.3602967,HOVERING_ALTITUDE) #dummy
    ...
    while True:
        ...
        if nextwaypoint==5 and processflag != True:
            drone.groundspeed = 3.00
        if nextwaypoint==6 and processflag != True :#Skip to next waypoint
    ...
    addWaypoint(cmds,40.812068, 29.360406,HOVERING_ALTITUDE)#direge capraz
