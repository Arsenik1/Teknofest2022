...
HOVERING_ALTITUDE    = 1.0 # Altitude in meters to which the drone will perform its tasks
...
if __name__ == "__main__":
	...
	waterPool = LocationGlobalRelative(38.7896604,30.4827827,10) #yukseklik 10 dikkat et
	cmds = drone.commands
	processflag = True
	redAreaTime=False
	detected = False
	...
	# addWaypoint(cmds,38.7899760, 30.4823262,HOVERING_ALTITUDE)#inis
	# addWaypoint(cmds,38.7899760, 30.4823262,HOVERING_ALTITUDE)#inis #dummy
	# Reset mission set to first (0) waypoint
