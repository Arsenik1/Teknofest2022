...
def get_target_coordinates(vid_cam,redOrBlue):
    ...
    if redOrBlue == 1:
        HSV_LOWER_BOUND = (72, 52, 102) #yeni olcum: 92, 120(81), 30 //// 72, 52, 102 (calisiyor) //// 80, 95, 20 (calismiyor)
        HSV_UPPER_BOUND = (108, 255, 255)#yeni olcum: 106, 255, 255 //// 110, 255, 255 (calisiyor) //// 120, 255, 255 (calismiyor)
...
if __name__ == "__main__":
    ...
    waterPool = LocationGlobalRelative(40.8118473,29.3603445,6)
    cmds = drone.commands
    ...
    while True:
        ...
        time.sleep(0.0001)
    #drone.groundspeed = 2.00
    drone.parameters['WPNAV_SPEED']=300
    drone.mode = VehicleMode("GUIDED")
